...
preliminary_workflow1.add(append(name="BRAINSConstellationDetector1", t1=preliminary_workflow1.source_node.lzout.t1, appended="_bcd"))
preliminary_workflow1.add(append(name="BRAINSResample1", t1=preliminary_workflow1.BRAINSConstellationDetector1.lzout.out, appended="_resampled"))
preliminary_workflow1.set_output([("processed", preliminary_workflow1.BRAINSResample1.lzout.out)])
