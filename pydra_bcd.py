...
#        "--inputVolume",
#        "/Shared/sinapse/chdi_bids/PREDICTHD_BIDS_DEFACE/sub-697343/ses-50028/anat/sub-697343_ses-50028_run-002_rec-physicalACPC_T1w.nii.gz",
#        "--interpolationMode",
#        "Linear",
#        "--outputLandmarksInACPCAlignedSpace",
#        f"{SESS_OUTPUT_DIR}/{OUT_FILE_BASE}_BCD_ACPC_Landmarks.fcsv",
#        "--outputLandmarksInInputSpace",
#        f"{SESS_OUTPUT_DIR}/{OUT_FILE_BASE}_BCD_Original.fcsv",
#        "--outputResampledVolume",
#        f"{SESS_OUTPUT_DIR}/{OUT_FILE_BASE}_BCD_ACPC.nii.gz",
#        "--outputTransform",
#        f"{SESS_OUTPUT_DIR}/{OUT_FILE_BASE}_BCD_Original2ACPC_transform.h5",
#        "--writeBranded2DImage",
#        f"{SESS_OUTPUT_DIR}/{OUT_FILE_BASE}_BCD_Branded2DQCimage.png",
#        "--inputVolume",
#        f"{INPUT_VOL}",
#    ]
#
