...
preliminary_workflow3 = pydra.Workflow(
    name="preliminary_workflow3", input_spec=["t1"], t1=source_node.lzin.t1_list
)
...
preliminary_workflow3.add(
    append_filename(
        ...
        filename=preliminary_workflow3.lzin.t1,
...
bcd_task = BRAINSConstellationDetector(
    name="BRAINSConstellationDetector3",
...
bcd_task.inputs.outputLandmarksInInputSpace = (
    preliminary_workflow3.outputLandmarksInInputSpace.lzout.out
)
bcd_task.inputs.outputResampledVolume = (
    preliminary_workflow3.outputResampledVolume.lzout.out
)
...
bcd_task.inputs.outputLandmarksInACPCAlignedSpace = (
    preliminary_workflow3.outputLandmarksInACPCAlignedSpace.lzout.out
)
bcd_task.inputs.writeBranded2DImage = (
    preliminary_workflow3.writeBranded2DImage.lzout.out
)
...
preliminary_workflow3.set_output(
    [
        (
...
source_node.set_output(
    [
        (
            "outputLandmarksInInputSpace",
            source_node.preliminary_workflow3.lzout.outputLandmarksInInputSpace,
        ),
        (
            "outputResampledVolume",
            source_node.preliminary_workflow3.lzout.outputResampledVolume,
        ),
        ("outputTransform", source_node.preliminary_workflow3.lzout.outputTransform),
        (
            "outputLandmarksInACPCAlignedSpace",
            source_node.preliminary_workflow3.lzout.outputLandmarksInACPCAlignedSpace,
        ),
        (
            "writeBranded2DImage",
            source_node.preliminary_workflow3.lzout.writeBranded2DImage,
        ),
