...
preliminary_workflow1.add(append(name="BRAINSResample",
                                 t1=preliminary_workflow1.source_node.lzout.t1,
                                 appended="_resampled"))
preliminary_workflow1.add(append(name="BRAINSConstellationDetector",
                                 t1=preliminary_workflow1.BRAINSResample.lzout.out,
                                 appended="_bcd"))
preliminary_workflow1.set_output([("processed", preliminary_workflow1.BRAINSConstellationDetector.lzout.out)])

sink_node = pydra.Workflow(name="sink_node", input_spec=["output_in_cache1"])
sink_node.add(preliminary_workflow1)
sink_node.add(append(name="append",
                     appended="_output").split("t1", t1=sink_node.preliminary_workflow1.lzout.processed))
