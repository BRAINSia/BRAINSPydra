...
preliminary_workflow1.add(append(name="BRAINSResample", t1=preliminary_workflow1.source_node.lzout.t1, appended="_resampled"))
preliminary_workflow1.add(append(name="BRAINSConstellationDetector", t1=preliminary_workflow1.BRAINSResample.lzout.out, appended="_bcd"))
