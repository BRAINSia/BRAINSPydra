...
preliminary_workflow2.add(pydra.ShellCommandTask(name="BRAINSResample", executable="echo", t1=preliminary_workflow2.source_node.lzout.t1, input_spec=my_input_spec, output_spec=my_output_spec))
