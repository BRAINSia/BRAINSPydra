...
input = [
    "/mnt/c/2020_Grad_School/Research/BRAINSPydra/input_files/subject1.txt",
    "/mnt/c/2020_Grad_School/Research/BRAINSPydra/input_files/subject2.txt",
]
...
preliminary_workflow4 = pydra.Workflow(
    name="preliminary_workflow4", input_spec=["input"], input=source_node.lzin.input
)
...
preliminary_workflow4.add(
    append_filename(
        name="outputLandmarksInInputSpace",
        filename=preliminary_workflow4.lzin.input,
...
BCD_task.inputs.outputLandmarksInInputSpace = (
    preliminary_workflow4.outputLandmarksInInputSpace.lzout.out
)
BCD_task.inputs.outputResampledVolume = (
    preliminary_workflow4.outputResampledVolume.lzout.out
)
...
BCD_task.inputs.outputLandmarksInACPCAlignedSpace = (
    preliminary_workflow4.outputLandmarksInACPCAlignedSpace.lzout.out
)
BCD_task.inputs.writeBranded2DImage = (
    preliminary_workflow4.writeBranded2DImage.lzout.out
)
...
preliminary_workflow4.add(
    append_filename(
        name="outputVolume",
        filename=preliminary_workflow4.BCD.lzout.outputResampledVolume,
...
RESAMPLE_task = BRAINSResample(
    name="RESAMPLE",
    executable="/mnt/c/2020_Grad_School/Research/BRAINSPydra/BRAINSResample3.sh",
).get_task()
...
preliminary_workflow4.set_output(
    [
        (
            "outputLandmarksInInputSpace",
            preliminary_workflow4.BCD.lzout.outputLandmarksInInputSpace,
        ),
        (
            "outputResampledVolume",
            preliminary_workflow4.BCD.lzout.outputResampledVolume,
        ),
        ("outputTransform", preliminary_workflow4.BCD.lzout.outputTransform),
        (
            "outputLandmarksInACPCAlignedSpace",
            preliminary_workflow4.BCD.lzout.outputLandmarksInACPCAlignedSpace,
        ),
...
source_node.set_output(
    [
        (
            "outputLandmarksInInputSpace",
            source_node.preliminary_workflow4.lzout.outputLandmarksInInputSpace,
        ),
        (
            "outputResampledVolume",
            source_node.preliminary_workflow4.lzout.outputResampledVolume,
        ),
        ("outputTransform", source_node.preliminary_workflow4.lzout.outputTransform),
        (
            "outputLandmarksInACPCAlignedSpace",
            source_node.preliminary_workflow4.lzout.outputLandmarksInACPCAlignedSpace,
        ),
        (
            "writeBranded2DImage",
            source_node.preliminary_workflow4.lzout.writeBranded2DImage,
        ),
...
sink_node = pydra.Workflow(
    ...
    cache_dir="/mnt/c/2020_Grad_School/Research/BRAINSPydra/cache_dir",
)
...
sink_node.add(
    copy_from_cache(
        ...
        cache_path=sink_node.source_node.lzout.outputLandmarksInInputSpace,
    )
)
sink_node.add(
    copy_from_cache(
        name="outputResampledVolume",
        output_dir="/mnt/c/2020_Grad_School/Research/BRAINSPydra/output_dir",
        cache_path=sink_node.source_node.lzout.outputResampledVolume,
    )
)
sink_node.add(
    copy_from_cache(
        name="outputTransform",
        output_dir="/mnt/c/2020_Grad_School/Research/BRAINSPydra/output_dir",
        cache_path=sink_node.source_node.lzout.outputTransform,
    )
)
sink_node.add(
    copy_from_cache(
        name="outputLandmarksInACPCAlignedSpace",
        output_dir="/mnt/c/2020_Grad_School/Research/BRAINSPydra/output_dir",
        cache_path=sink_node.source_node.lzout.outputLandmarksInACPCAlignedSpace,
    )
)
sink_node.add(
    copy_from_cache(
        name="writeBranded2DImage",
        output_dir="/mnt/c/2020_Grad_School/Research/BRAINSPydra/output_dir",
        cache_path=sink_node.source_node.lzout.writeBranded2DImage,
    )
)
sink_node.add(
    copy_from_cache(
        name="outputVolume",
        output_dir="/mnt/c/2020_Grad_School/Research/BRAINSPydra/output_dir",
        cache_path=sink_node.source_node.lzout.outputVolume,
    )
)
