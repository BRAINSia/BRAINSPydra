...
processing_node = pydra.Workflow(name="processing_node", input_spec=["x"], x=source_node.lzin.x)
...
processing_node.set_output([("add2_1", processing_node.add2_1.lzout.out),
